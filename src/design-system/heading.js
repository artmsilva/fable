...
class FableHeading extends LitElement {
  ...
  static styles = css`
    ...
    /* Size scale derived from semantic level */
    ...
    h1, h2, h3, h4, h5, h6 {
      ...
      font-weight: 400;
      font-size: var(--_fs, 1.1rem);
      line-height: var(--_lh, 1.3);
      letter-spacing: 0;
...
customElements.define("fable-heading", FableHeading);

// Stories
const meta = getComponentStoryMeta("heading", {
  args: { level: 3 },
  argTypes: {
