...
This index lists every active or archived user thread so agents can see who owns what at a glance. Follow the workflow in `docs/agents/progress-tracking.md` when adding or updating entries.

| Thread | Owner | Status | Last Update | Summary |
| ------ | ----- | ------ | ----------- | ------- |
...
| [2025-11-28-homepage](ops/threads/2025-11-28-homepage.md) | codex | Done | 2025-11-30 | Implement Homepage / Discovery view per spec (router + hero/cards/recent data). |
